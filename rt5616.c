...
struct rt5616_priv *g_rt5616;
/*
*	parameters: onoff 1: means ON; 0: means OFF
*
*/
void rt5616_set_data_bypass(unsigned char onoff)
{
	printk("[Keen] %s %d %s \r\n",__func__,__LINE__,__FILE__);
	if (onoff == 1) {
#if 0
		regmap_write(g_rt5616->regmap, RT5616_D_MISC, 0x0011);
		regmap_write(g_rt5616->regmap, RT5616_PRIV_INDEX, 0x003d);
		regmap_write(g_rt5616->regmap, RT5616_PRIV_DATA, 0x3e00);
		regmap_write(g_rt5616->regmap, RT5616_PWR_DIG1, 0xc000);
		regmap_write(g_rt5616->regmap, RT5616_PWR_DIG2, 0x4400);
		regmap_write(g_rt5616->regmap, 0x79, 0x0101);
		regmap_write(g_rt5616->regmap, 0x73, 0x0004);
		//regmap_write(g_rt5616->regmap, 0x77, 0x0e00);	/* stereo2 */
		//regmap_write(g_rt5616->regmap, 0x77, 0x0c00);	/* stereo1 */
		regmap_write(g_rt5616->regmap, 0x77, 0x4e00);	/* TDM enabled, stereo2 */
		regmap_write(g_rt5616->regmap, 0x28, 0x5858);	/* stereo2 */
		regmap_write(g_rt5616->regmap, 0x2b, 0x4040);	/* stereo2 */
		regmap_write(g_rt5616->regmap, 0x1b, 0x0000);
		regmap_write(g_rt5616->regmap, 0x1d, 0x2f2f);
    //            regmap_write(g_rt5616->regmap, RT5616_GLB_CLK, 0x5000);
#endif
#if 1
                regmap_write(g_rt5616->regmap, RT5616_D_MISC, 0x0011);
                regmap_write(g_rt5616->regmap, RT5616_PRIV_INDEX, 0x003d);
                ...
                regmap_write(g_rt5616->regmap, RT5616_PWR_DIG1, 0xc000);
                regmap_write(g_rt5616->regmap, RT5616_PWR_DIG2, 0x4400);
                regmap_write(g_rt5616->regmap, RT5616_PWR_ANLG1, 0x20c6);
                regmap_write(g_rt5616->regmap, RT5616_PWR_ANLG2, 0x0200);

                regmap_write(g_rt5616->regmap, RT5616_PLL_CTRL1, 0x0f06);
                regmap_write(g_rt5616->regmap, RT5616_PLL_CTRL2, 0x0802);
    ...
    //            regmap_write(g_rt5616->regmap, RT5616_GLB_CLK, 0x5000);
		...
		regmap_write(g_rt5616->regmap, RT5616_PWR_DIG1, 0x0000);
		regmap_write(g_rt5616->regmap, RT5616_PWR_DIG2, 0x0000);
                regmap_write(g_rt5616->regmap, RT5616_PWR_ANLG1, 0xE8DA);
                regmap_write(g_rt5616->regmap, RT5616_PWR_ANLG2, 0x0000);

                regmap_write(g_rt5616->regmap, RT5616_PLL_CTRL1, 0x0);
                regmap_write(g_rt5616->regmap, RT5616_PLL_CTRL2, 0x0);
                regmap_write(g_rt5616->regmap, RT5616_GLB_CLK,   0x0);
	}
}
EXPORT_SYMBOL(rt5616_set_data_bypass);
			    ...
			    const struct i2c_device_id *id)
{
	...
	g_rt5616 = rt5616;
	printk("[Keen] 5616 bypass \r\n");
	rt5616_set_data_bypass(0);
#if 0
        for(i=RT5616_RESET ;i<=RT5616_DUMMY3 ; i++)
	{
		val=0x0;
		regmap_read(rt5616->regmap, i, &val);
...
static struct i2c_driver rt5616_i2c_driver = {
	.driver = {
		.name = "rt5616",
		.of_match_table = rt5616_of_match,
	},
